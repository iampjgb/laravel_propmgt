...
export default function Receivables(): React.JSX.Element {
  const page = usePage<{ section: Section; customers?: Pagination<Customer>; filters?: Filters }>()
  const { section, customers, filters } = page.props
    ...
    <AppSidebarLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-6 bg-white">
        ...
        {section === 'customers' && customers && filters && (
          <Customers section={section} customers={customers} filters={filters} />
        )}
